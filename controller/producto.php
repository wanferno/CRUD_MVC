        ...
        case "guardaryeditar":
            ...
            if(empty($_POST["prod_id"])){
                if(is_array($datos)==true and count($datos)==0){
                    $producto->insert_producto($_POST["cat_id"],$_POST["prod_nom"],$_POST["prod_des"],$_POST["prod_cant"]);
                }
            }else{
                $producto->update_producto($_POST["prod_id"],$_POST["cat_id"],$_POST["prod_nom"],$_POST["prod_des"],$_POST["prod_cant"]);
            }
            break;
